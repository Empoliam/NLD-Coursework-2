...
%   Output:
%
%   xend - final computed values, column i corresponding to column i of x0
%   t - vector of times used
%   xt - tensor, page i corresponds to time t(i)
%
...
xt = zeros(length(x0(:,1)),length(x0(1,:)),maxIter);
%Intial Values
xt(:,:,1) = x0;
